<template>
  <div class="center">
        ...
        <form @submit.prevent="modifyComplete()">
            ...
            <label></label>
            <div class="input">
                <input type="text" v-model="userName" name="userName" disabled required/>
                <span></span>
                <label>이름</label>
            </div>
            <div class="input">
                <input type="text" v-model="userPwd" name="userPwd" v-bind:disabled="!modifyState" required/>
                <span></span>
                <label>비밀번호</label>
            </div>
            <div class="input">
                <input type="text" v-model="userGender" name="userGender" v-bind:disabled="!modifyState" required/>
                <span></span>
                <label>성별</label>
            </div>
            <div class="input">
                <input type="text" v-model="userEmail" name="userEmail" v-bind:disabled="!modifyState" required/>
                <span></span>
                <label>이메일</label>
            </div>
            <div class="input" v-if="!modifyState">
                ...
                <input type="button" @click="home()" id="cancel" value="메인 페이지로"/>
            </div>
            <div class="input" v-else>
                <input type="button" @click="modifyComplete()" id="modifyBtn" value="수정 완료"/>
