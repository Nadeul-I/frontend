...
async function IdCheck(userInfo, success, fail) {
  await api
    .post(`/user/idcheck`, JSON.stringify(userInfo))
    .then(success)
    .catch(fail);
}
...
async function FindPwd(userInfo, success, fail) {
  await api
    .post(`/user/findpwd`, JSON.stringify(userInfo))
    .then(success)
    .catch(fail);
}
...
async function SignUp(userInfo, success, fail) {
  await api
    .post(`/user/signup`, JSON.stringify(userInfo))
    .then(success)
    .catch(fail);
}
...
async function Withdraw(userInfo, success, fail) {
  await api
    .post(`/user/withdraw`, JSON.stringify(userInfo))
    .then(success)
    .catch(fail);
}
...
async function userModify(userInfo, success, fail) {
  await api
    .put(`/user/modify`, JSON.stringify(userInfo))
    .then(success)
    .catch(fail);
}
...
async function myPage(userId, success, fail) {
  await api
    .get(`/user/mypage/${userId}`, JSON.stringify(userId))
    .then(success)
    .catch(fail);
}
